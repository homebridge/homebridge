...
exports.MatterConfigValidator = void 0;
exports.validatePort = validatePort;
exports.sanitizeUniqueId = sanitizeUniqueId;
exports.truncateString = truncateString;
exports.checkPortProximity = checkPortProximity;
 ...
 */
function validatePort(port, checkConflicts = false) {
...
function sanitizeUniqueId(uniqueId) {
    ...
    const sanitized = uniqueId.replace(/:/g, '').toUpperCase();
 ...
 */
function truncateString(value, maxLength, fieldName) {
    const warnings = [];
 ...
 */
function checkPortProximity(hapPort, matterPort) {
...
exports.MatterConfigValidator = MatterConfigValidator;
