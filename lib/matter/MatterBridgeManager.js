...
exports.MatterBridgeManager = void 0;
...
const log = logger_js_1.Logger.withPrefix('Matter/MainManager');
/**
 * Manages Matter server and accessories for the main bridge
 */
class MatterBridgeManager extends BaseMatterManager_js_1.BaseMatterManager {
    config;
    api;
    externalPortService;
    options;
    ...
    async initialize() {
        ...
        try {
            ...
            const networkInterfaces = (0, utils_js_1.normalizeBindConfig)(this.config.bridge.bind);
            ...
            const errorCode = (0, utils_js_1.getErrorCode)(error);
...
exports.MatterBridgeManager = MatterBridgeManager;
