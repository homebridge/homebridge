...
exports.MatterPortAllocator = void 0;
const logger_js_1 = require("../logger.js");
const log = logger_js_1.Logger.withPrefix('Matter/PortAllocator');
/**
...
class MatterPortAllocator {
    ...
    getNextFreePort() {
        ...
        const allocatedPortValues = new Set([
            ...
            ...Array.from(this.allocatedPorts.values()).filter((p) => p !== undefined),
        ]);
...
exports.MatterPortAllocator = MatterPortAllocator;
