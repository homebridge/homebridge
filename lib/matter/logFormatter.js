...
exports.createHomebridgeLogFormatter = createHomebridgeLogFormatter;
 ...
 */
function createHomebridgeLogFormatter() {
    // Capture timestamp setting once when formatter is created
    const timestampEnabled = logger_js_1.Logger.isTimestampEnabled();
    return (diagnostic) => {
            ...
            if (msg.now && msg.facility && msg.values) {
                ...
                if (msg.level !== undefined) {
                    switch (msg.level) {
                        ...
                        case 5: // FATAL
                        case 4: // ERROR
                            coloredMessage = chalk_1.default.red(messageText);
                            break;
                        case 3: // WARN
                            coloredMessage = chalk_1.default.yellow(messageText);
                            break;
                        case 0: // DEBUG
                            coloredMessage = chalk_1.default.gray(messageText);
                            break;
                    }
                }
...
function formatHomebridgeTimestamp(date) {
    ...
    return chalk_1.default.white(timestamp);
}
/**
...
function formatMessageValues(values) {
    ...
    return values
        ...
        if (typeof value === 'object') {
            ...
            const diagnosticValue = general_1.Diagnostic.valueOf(value);
