...
class PlatformAccessory extends node_events_1.EventEmitter {
    ...
    constructor(displayName, uuid, category) {
        ...
        this.category = category || hap_nodejs_1.Categories.OTHER;
        this.services = this._associatedHAPAccessory.services;
        // forward identify event
        this._associatedHAPAccessory.on(hap_nodejs_1.AccessoryEventTypes.IDENTIFY, (paired, callback) => {
