...
// Legacy types doen't appear to be exported from HAP-NodeJS
// Make sure we handle getting them from either the location
// in a published npm package, or from the dist folder when
// working locally (e.g., using npm link).
try {
