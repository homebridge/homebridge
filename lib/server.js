...
Server.prototype._publish = function() {
  ...
  info.setCharacteristic(Characteristic.Manufacturer, bridgeConfig.manufacturer || `${toLowerCase(require('../package.json').author.name)}`);
  info.setCharacteristic(Characteristic.Model, bridgeConfig.model || `${toLowerCase(require('../package.json').name)}`);
