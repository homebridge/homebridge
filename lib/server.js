...
Server.prototype._createAccessory = function(accessoryInstance, displayName, accessoryType, uuid_base) {
  ...
  console.log("********************************");    
  console.log("Called createAccessory as defined in homebridge server.js, returned service definition of ");
    ...
    services.forEach(function(service) {
      ...
      if (service instanceof Service.AccessoryInformation) {
        ...
        accessory.addService(service);
          console.log("********************************");    
  console.log("Added an accessory to the service. Added accessory is: ");
  console.log(service);
  console.log("==================================");
      }
    });
