...
Plugin.prototype.load = function(options) {
  ...
  if (pjson.peerDependencies && (!pjson.engines || !pjson.engines.homebridge)) {
    var engines = pjson.engines || {}
    engines.homebridge = pjson.peerDependencies.homebridge;
  ...
  if (!semver.satisfies(version, versionRequired, { includePrerelease: true })) {
