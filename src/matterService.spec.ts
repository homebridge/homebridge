...
describe('matterService', () => {
  ...
  beforeEach(() => {
    ...
    mockExternalPortService = {} as ExternalPortService
    mockApi = {} as HomebridgeAPI
  })
  ...
  it('should use custom configuration values', () => {
    const customConfig = {
      ...
      port: 5541,
      discriminator: 1234,
      passcode: 48291537, // Use a secure passcode for testing
      vendorId: 0x1234,
      productId: 0x5678,
    ...
    expect(config.passcode).toBe(48291537)
