...
describe('deviceRequirements', () => {
  ...
  it('exposes a requirements entry for every feature-gated device type', () => {
    for (const name of ['MotionSensor', 'SmokeSensor', 'ElectricalSensor', 'Thermostat', 'Closure', 'RoboticVacuumCleaner', 'WaterValve', 'GenericSwitch', 'Pump', 'RoomAirConditioner'] as const) {
