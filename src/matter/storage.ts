...
/**
 * Serialized special types that need reconstruction
 */
...
/**
 * Type guard for serialized BigInt
 */
...
/**
 * Type guard for serialized Uint8Array
 */
function isSerializedUint8Array(obj: unknown): obj is SerializedUint8Array {
  return typeof obj === 'object'
    && obj !== null
    && '__type' in obj
    && (obj as SerializedUint8Array).__type === 'Uint8Array'
    && 'value' in obj
    && Array.isArray((obj as SerializedUint8Array).value)
}

/**
 * Type guard for serialized Buffer
 */
function isSerializedBuffer(obj: unknown): obj is SerializedBuffer {
  return typeof obj === 'object'
    && obj !== null
    && 'type' in obj
    && (obj as SerializedBuffer).type === 'Buffer'
    && 'data' in obj
    && Array.isArray((obj as SerializedBuffer).data)
}
...
export class HomebridgeMatterStorage {
   ...
   * without rewriting Matter.js' storage interface.
   */
  private initializeSync(): void {
    try {
      ...
      if (data && typeof data === 'object') {
        ...
        const entries: Array<[string, unknown]> = Object.entries(data).map(([key, value]) => [
          key,
  ...
  private async schedulePersist(): Promise<void> {
    ...
    // Optimized: iterate Map directly instead of creating intermediate array
