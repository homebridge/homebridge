...
Install the LTS version of Node.js from the [official repository](https://github.com/nodesource/distributions#installation-instructions), as well as additional dependencies:
